...
# Funkcja do obsługi sterowania grą
def control_game(gesture):
    if gesture == "pointer":  # Schylenie się
        pyautogui.keyDown("down")
        # time.sleep(0.1)  # Symulacja krótkiego wciśnięcia
        pyautogui.keyUp("down")
    elif gesture == "open_hand":  # Skok
...
def main():
    ...
    with GestureRecognizer.create_from_options(options) as recognizer:
        ...
        while True:
            ...
            # Sterowanie grą na podstawie gestu
            control_game(recognized_gesture)
